...
public class ReMasq {
    ...
    public ReMasq(File inFile, File outFile)
        ...
        // Create an InfiniteIntArrayQueue to keep the content of time column.
        InfiniteIntArrayQueue timeQ = new InfiniteIntArrayQueue(100);
        // Create an InfiniteIntArrayStack to keep the content of displacement column.
        InfiniteIntArrayStack dispStack = new InfiniteIntArrayStack(100);
